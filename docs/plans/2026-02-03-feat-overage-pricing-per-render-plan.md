...
<div class="border-2 border-gray-900 p-4 bg-white shadow-[4px_4px_0_0_#1f2937]">
  <label class="flex items-center gap-3 cursor-pointer">
    <input type="checkbox" bind:checked={allowOverages}
    ...
    <div class="mt-4 pl-8">
      ...
      <div class="flex gap-2">
        {#each presets as amount}
          <button class="px-3 py-1 border-2 border-gray-900
                         {spendingCap === amount ? 'bg-blue-500 text-white' : 'bg-white'}">
            ${amount}
          </button>
        {/each}
        <input type="number" bind:value={customCap} placeholder="Custom"
