...
<section>
	...
	<main>
		<div class="w-full max-w-4xl m-auto">
			...
			<h1 class="opacity-70 md:px-0 px-6 text-left text-lg mt-2">
				Choose the plan that's right for your needs and start converting HTML to images and GIFs
				today.
			</h1>
				...
				<table class="w-full mt-10 border-collapse text-lg">
					<thead>
						<tr>
							...
							<th class="text-center p-4 border-b"> Selected </th>
						</tr>
					</thead>
					<tbody>
			...
			<div class="mt-20 w-full">
				...
				<div class="mt-10 md:px-0 px-6 flex flex-col max-w-6xl mx-auto gap-6">
					{#each FAQs as faq}
						<div
							class="flex-1 rounded-xl p-4 border-[3px] border-gray-900 bg-[#EBEBEB] cursor-pointer"
						>
