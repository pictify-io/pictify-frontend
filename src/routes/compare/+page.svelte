...
const description = 'Compare Pictify to other image generation services like Cloudinary, imgix, Placid, and self-hosted Puppeteer solutions.';
...
<svelte:head>
	...
	<meta name="keywords" content="pictify comparison, cloudinary alternative, imgix alternative, html to image comparison, image generation api comparison" />
	...
	<main class="w-full max-w-6xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-16 md:pt-20 md:pb-32 relative z-10">
		...
		<div class="relative flex flex-col items-center justify-center text-center mb-16 pt-4 sm:pt-8">
			...
			<div class="inline-flex transform -rotate-2 hover:rotate-0 transition-transform duration-300 cursor-default mb-6">
				<div class="px-6 py-2 bg-[#ff6b6b] border-[3px] border-gray-900 text-white font-black text-sm uppercase tracking-widest shadow-[4px_4px_0_0_#1f2937] rounded-lg">
					Honest Comparisons
				</div>
			</div>
			...
			<p class="text-lg sm:text-xl text-gray-600 font-bold leading-relaxed max-w-2xl">
				Honest, side-by-side comparisons to help you choose the right tool for your image generation needs.
			</p>
		</div>
					...
					>
						<div class="p-6 h-full flex flex-col relative z-10 bg-white rounded-xl">
							...
							<div class="flex items-center justify-between mb-8">
								<!-- Pictify Icon -->
								<div class="w-14 h-14 bg-gray-900 border-[3px] border-gray-900 rounded-xl flex items-center justify-center shadow-[3px_3px_0_0_#1f2937]">
								...
								<!-- Competitor Icon -->
								<div class="w-14 h-14 bg-white border-[3px] border-gray-900 rounded-xl flex items-center justify-center text-2xl shadow-[3px_3px_0_0_#1f2937] transition-transform group-hover:scale-110" style="color: {icon.color || '#1f2937'}">
								{#if icon.type === 'url'}
							...
							<div class="mb-4">
								<h2 class="text-2xl font-black text-gray-900 mb-2 group-hover:text-[#ff6b6b] transition-colors leading-tight">
									Pictify vs <br/>{comparison.competitor}
								</h2>
								<div class="h-1 w-12 bg-[#ff6b6b] mb-4"></div>
		...
		<!-- Bottom CTA -->
		<section class="bg-gray-900 border-[4px] border-gray-900 rounded-3xl p-8 md:p-12 text-center shadow-[8px_8px_0_0_#ff6b6b]">
			<h2 class="text-3xl md:text-4xl font-black text-white mb-4">
				Ready to try Pictify?
			</h2>
