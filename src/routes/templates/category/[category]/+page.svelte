...
<svelte:head>
	...
	<meta name="keywords" content="{category?.keywords?.join(', ') || 'templates, image generator'}, Pictify" />
	...
	<main class="w-full max-w-6xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-16 md:pt-20 md:pb-32 relative z-10">
		{#if validCategory}
			...
			{#if category.recommendedSizes?.length}
				<div class="mb-16">
					<h2 class="text-xl font-black uppercase tracking-wide text-gray-400 mb-6 text-center">Recommended Sizes</h2>
					...
					<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
						{#each relatedUseCases as uc}
							...
							>
								...
								<span class="text-sm font-bold text-[#ff6b6b] uppercase tracking-wide flex items-center gap-2">
									Try it free
			...
			<section class="mb-20 bg-gray-900 border-[4px] border-gray-900 rounded-3xl p-8 md:p-12 text-center shadow-[8px_8px_0_0_#ff6b6b]">
				<h2 class="text-3xl md:text-4xl font-black text-white mb-4">
					Browse All Templates
				</h2>
				<p class="text-gray-400 font-bold mb-8 max-w-xl mx-auto">
					Explore our full template gallery with hundreds of ready-to-use designs across all categories.
				</p>
				<a
					href="/templates"
			...
			<section class="text-center">
				<h3 class="text-sm font-bold uppercase tracking-widest text-gray-400 mb-4">Related Topics</h3>
				<div class="flex flex-wrap justify-center gap-2">
					{#each category.keywords || [] as keyword}
						<span class="px-3 py-1 bg-gray-100 border border-gray-200 rounded-full text-sm font-medium text-gray-600">
							{keyword}
						</span>
					{/each}
				</div>
		...
		{:else}
			...
			<div class="min-h-[50vh] flex flex-col items-center justify-center text-center space-y-8 px-4">
				...
				<h1 class="text-4xl md:text-6xl font-black uppercase tracking-tighter text-gray-900">Category not found</h1>
				<a
					href="/templates"
