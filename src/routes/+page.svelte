...
<svelte:head>
    ...
    <meta name="description" content="Convert HTML to Image or Gif using free HTML to Image API by Pictify.io. Perfect for developers to generate images from HTML at scale with ease.">
