...
<div class="min-h-screen bg-[#FFFDF8]">
	...
	<section class="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden" in:fly={{ y: 30, duration: 600 }}>
		...
		<div class="absolute top-10 right-10 w-24 h-24 bg-[#ffc480] rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob"></div>
		<div class="absolute -bottom-10 left-10 w-32 h-32 bg-[#4ade80] rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-2000"></div>
		<div class="absolute top-20 left-40 w-28 h-28 bg-[#a78bfa] rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-4000"></div>
		...
		<div class="max-w-6xl mx-auto text-center relative z-10">
			...
			>
				...
				<span class="text-xs sm:text-sm font-black uppercase tracking-wider text-gray-900">Works With Mailchimp · SendGrid · Klaviyo</span>
			</div>
