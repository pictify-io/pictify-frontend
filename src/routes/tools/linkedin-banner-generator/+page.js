...
export function load() {
  return {
    title: 'Free LinkedIn Banner Generator | Create Professional Profile Banners',
    ...
    keywords: 'linkedin banner generator, linkedin cover photo, linkedin background, profile banner, linkedin header'
  };
}
