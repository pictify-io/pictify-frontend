...
const structuredDataJson = JSON.stringify({
  ...
  function sharePage(platform) {
    ...
    if (platform === 'twitter') {
      ...
      window.open(`https://www.linkedin.com/shareArticle?mini=true&url=${url}&title=${encodeURIComponent('Invoice Generator')}&summary=${text}`, '_blank');
    }
  }
...
<section class="w-full min-h-screen bg-[#FFFDF8] relative overflow-x-hidden font-['Manrope']">
  ...
  <main class="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-16 md:pt-24 md:pb-32 relative z-10">
    ...
    <div class="relative flex flex-col items-center justify-center text-center mb-8 sm:mb-12 lg:mb-16 pt-4 sm:pt-10">
      ...
      <div class="max-w-2xl mx-auto px-2">
        <p class="text-base sm:text-lg md:text-xl text-gray-800 font-bold leading-relaxed border-[3px] border-black bg-white p-4 sm:p-6 shadow-[4px_4px_0_0_#e5e7eb] sm:shadow-[8px_8px_0_0_#e5e7eb]">
          Create <span class="bg-[#ffc480] px-1 border-b-[2px] sm:border-b-[3px] border-black">professional invoices</span> for your business.
          <span class="text-gray-500 text-sm sm:text-base mt-2 sm:mt-3 block font-semibold">Free, customizable templates with real-time preview</span>
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
      ...
      <div class="bg-white border-[3px] border-black shadow-[6px_6px_0_0_#000] sm:shadow-[8px_8px_0_0_#000] overflow-hidden">
        ...
        <div class="p-4 sm:p-6 space-y-4">
          ...
          <div class="space-y-3">
            <h3 class="text-xs font-black text-black uppercase tracking-wider flex items-center gap-2">
              <span class="w-6 h-6 bg-[#ffc480] border-[2px] border-black flex items-center justify-center text-xs">1</span>
              Your Company
            </h3>
        <input
        ...
        ></textarea>
          ...
          <div class="space-y-3">
            <h3 class="text-xs font-black text-black uppercase tracking-wider flex items-center gap-2">
              <span class="w-6 h-6 bg-[#60a5fa] border-[2px] border-black flex items-center justify-center text-xs text-white">2</span>
              Client Info
            </h3>
        <input
        ...
        ></textarea>
          ...
          <div class="space-y-3">
            <h3 class="text-xs font-black text-black uppercase tracking-wider flex items-center gap-2">
              <span class="w-6 h-6 bg-[#a78bfa] border-[2px] border-black flex items-center justify-center text-xs text-white">3</span>
              Invoice Details
            </h3>
        ...
        />
          ...
          <div class="space-y-3">
            <h3 class="text-xs font-black text-black uppercase tracking-wider flex items-center gap-2">
              <span class="w-6 h-6 bg-[#ff6b6b] border-[2px] border-black flex items-center justify-center text-xs text-white">4</span>
              Line Items
            </h3>
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-xs font-black text-black uppercase tracking-wider mb-2">Tax Rate (%)</label>
          <input
      ...
      <div class="space-y-4 sm:space-y-6">
        <div class="bg-white border-[3px] border-black shadow-[6px_6px_0_0_#000] sm:shadow-[8px_8px_0_0_#000] overflow-hidden">
          <!-- Preview Header -->
          <div class="bg-[#e5e7eb] px-4 py-2 border-b-[3px] border-black flex items-center justify-between">
          ...
          <div bind:this={invoiceTemplateWrapper} bind:clientWidth={previewContainerWidth} class="overflow-hidden bg-white flex justify-center">
      ...
      {#if isImageGenerating}
          <div class="bg-white border-[3px] border-black p-4 shadow-[4px_4px_0_0_#000]">
            ...
            <div class="w-full bg-gray-200 border-[2px] border-black h-4">
              <div class="bg-black h-full loading-bar"></div>
        </div>
      </div>
      {/if}
      ...
      {#if imageUrl}
          <div class="bg-white border-[3px] border-black shadow-[6px_6px_0_0_#000] overflow-hidden">
            <div class="bg-[#4ade80] px-4 py-3 border-b-[3px] border-black flex items-center justify-between">
              <span class="font-black uppercase tracking-wider text-sm text-black">✓ Invoice Generated</span>
            <button
            ...
            <div class="p-4 flex flex-col gap-4">
              <a href={imageUrl} target="_blank" class="px-6 py-3 bg-white border-[3px] border-black font-bold uppercase tracking-wide hover:bg-[#ffc480] transition-colors shadow-[4px_4px_0_0_#000] hover:shadow-[2px_2px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] text-center text-sm">
                Open in New Tab
              </a>
              <img src={imageUrl} alt="Invoice" class="w-full h-auto border-[3px] border-black shadow-[4px_4px_0_0_#000]" />
    ...
    <div class="mt-12 sm:mt-16">
      <h2 class="text-xl sm:text-2xl font-black mb-6 flex items-center gap-3">
        <span class="w-8 h-8 bg-[#ffc480] border-[3px] border-black flex items-center justify-center shadow-[2px_2px_0_0_#000]">
      ...
      {#each templates as template}
          <button
            class="relative bg-white border-[3px] {selectedTemplate === template ? 'border-[#ff6b6b] shadow-[6px_6px_0_0_#ff6b6b]' : 'border-black shadow-[4px_4px_0_0_#000]'} p-3 overflow-hidden hover:shadow-[2px_2px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all cursor-pointer"
          on:click={() => updateTemplate(template)}
        >
            {#if selectedTemplate === template}
              <div class="absolute top-2 right-2 z-10 w-6 h-6 bg-[#ff6b6b] border-[2px] border-black flex items-center justify-center">
  ...
  <!-- Separator -->
      ...
      <h2 class="text-2xl sm:text-3xl md:text-5xl font-black mb-8 sm:mb-12 text-center text-gray-900 tracking-tighter px-2">
      ...
      <!-- Benefits Section -->
      <section class="mb-8 sm:mb-12 bg-white border-[3px] border-black shadow-[4px_4px_0_0_#000] sm:shadow-[8px_8px_0_0_#000] p-4 sm:p-6 md:p-10 hover:shadow-[2px_2px_0_0_#000] sm:hover:shadow-[4px_4px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] sm:hover:translate-x-[4px] sm:hover:translate-y-[4px] transition-all duration-300">
        <div class="inline-flex items-center gap-2 px-3 sm:px-4 py-1 bg-[#4ade80] border-[3px] border-black text-[10px] sm:text-xs font-black uppercase tracking-wider mb-4 sm:mb-6 shadow-[2px_2px_0_0_#000] sm:shadow-[3px_3px_0_0_#000]">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {#each ['Create professional invoices in minutes', 'Customize templates to match your brand', 'Automate calculations for taxes and totals', 'Save time on billing and bookkeeping', 'Access your invoices from anywhere', 'Improve cash flow with accurate billing'] as benefit}
            <div class="bg-[#f8f8f8] border-[3px] border-black p-3 shadow-[3px_3px_0_0_#000] flex items-center gap-3 hover:shadow-[1px_1px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
      ...
      <!-- How to Use Section -->
      <section class="mb-8 sm:mb-12 bg-white border-[3px] border-black shadow-[4px_4px_0_0_#000] sm:shadow-[8px_8px_0_0_#000] p-4 sm:p-6 md:p-10 hover:shadow-[2px_2px_0_0_#000] sm:hover:shadow-[4px_4px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] sm:hover:translate-x-[4px] sm:hover:translate-y-[4px] transition-all duration-300">
        <div class="inline-flex items-center gap-2 px-3 sm:px-4 py-1 bg-[#60a5fa] border-[3px] border-black text-white text-[10px] sm:text-xs font-black uppercase tracking-wider mb-4 sm:mb-6 shadow-[2px_2px_0_0_#000] sm:shadow-[3px_3px_0_0_#000]">
        ...
        <div class="space-y-4">
          {#each [
            { num: '1', text: 'Enter your company and client details' },
            { num: '2', text: 'Choose from our professional invoice templates' },
            { num: '3', text: 'Add line items for products or services' },
            { num: '4', text: 'Set tax rates and discounts if applicable' },
            { num: '5', text: 'Preview your invoice in real-time' },
            { num: '6', text: 'Generate and download your custom invoice' }
          ] as step}
            <div class="flex items-start gap-4">
              <span class="bg-[#60a5fa] text-white w-8 h-8 flex items-center justify-center font-black flex-shrink-0 border-[3px] border-black shadow-[2px_2px_0_0_#000]">{step.num}</span>
      ...
      <section class="mb-8 sm:mb-12 bg-white border-[3px] border-black shadow-[4px_4px_0_0_#000] sm:shadow-[8px_8px_0_0_#000] p-4 sm:p-6 md:p-10 hover:shadow-[2px_2px_0_0_#000] sm:hover:shadow-[4px_4px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] sm:hover:translate-x-[4px] sm:hover:translate-y-[4px] transition-all duration-300">
        ...
        <div class="space-y-3">
          {#each [
            { q: 'How do I use this invoice generator?', a: 'Simply fill in your company and client details, add invoice items, select a template, and click "Generate Invoice". You can then download your professional invoice.' },
            { q: 'Is this invoice generator free to use?', a: 'Yes, our online invoice generator is completely free to use. Create and download as many invoices as you need without any cost.' },
            { q: 'Can I customize the invoice template?', a: 'You can choose from a variety of professional designs. Each template can be populated with your specific invoice details.' },
            { q: 'Are the generated invoices legally compliant?', a: 'Our templates include standard elements required for most invoices. Please check your local regulations for specific requirements.' }
          ] as faq}
            <details class="group bg-[#f8f8f8] border-[3px] border-black overflow-hidden shadow-[3px_3px_0_0_#000] hover:shadow-[1px_1px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
              <summary class="flex items-center justify-between cursor-pointer p-4 font-bold text-black select-none text-sm">
                <span>{faq.q}</span>
