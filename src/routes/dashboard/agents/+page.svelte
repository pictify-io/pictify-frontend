<script>
	...
	// Official brand marks served from static/icons/agents/ (vendor favicons:
	// Claude's orange starburst, Cursor's cube, Windsurf's wave with the
	// background stripped, and the official MCP mark for generic clients).
	const LOGOS = {
		claude: '/icons/agents/claude.svg',
		cursor: '/icons/agents/cursor.svg',
		windsurf: '/icons/agents/windsurf.svg',
		mcp: '/icons/agents/mcp.svg'
	};
