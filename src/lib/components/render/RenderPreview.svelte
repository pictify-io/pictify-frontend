...
<div class="space-y-6">
	...
	<div class="relative bg-gray-50 border-[3px] border-gray-900 rounded-xl min-h-[400px] flex items-center justify-center overflow-hidden shadow-inner">
		...
		{#if isRendering}
			<div class="text-center py-12 relative z-10">
				<div class="relative w-20 h-20 mx-auto mb-6">
					<div class="absolute inset-0 border-[6px] border-gray-200 rounded-full"></div>
					<div class="absolute inset-0 border-[6px] border-[#ff6b6b] rounded-full border-t-transparent animate-spin"></div>
				</div>
				<p class="text-sm font-black text-gray-900 uppercase tracking-widest animate-pulse">Running Render Job...</p>
			</div>
		{:else if renderError}
			<div class="text-center py-12 px-6 relative z-10 max-w-sm">
				<div class="w-20 h-20 mx-auto mb-6 bg-red-100 border-[3px] border-red-200 rounded-full flex items-center justify-center">
					<svg class="w-10 h-10 text-[#ff6b6b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
		...
		{:else}
			<div class="text-center py-12 relative z-10">
				<div class="w-20 h-20 mx-auto mb-6 border-[3px] border-dashed border-gray-300 rounded-full flex items-center justify-center">
	...
	<!-- Result Info & Actions -->
	{#if renderResult?.url}
		<div class="bg-[#f0fdf4] border-[3px] border-[#4ade80] rounded-xl p-5 shadow-[4px_4px_0_0_#166534]">
