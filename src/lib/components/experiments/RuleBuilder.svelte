<script>
	...
	const PRESETS = [
		{
			label: 'Mobile Users',
			rules: [{ type: 'rule', property: 'device.type', operator: 'eq', value: 'mobile' }]
		},
		{
			label: 'Desktop Users',
			rules: [{ type: 'rule', property: 'device.type', operator: 'eq', value: 'desktop' }]
		},
		{
			label: 'US & Canada',
			rules: [
		...
		{
			label: 'Europe',
			rules: [{ type: 'rule', property: 'geo.continent', operator: 'eq', value: 'EU' }]
		},
		{
...
{:else}
	<div class="space-y-5">
		...
		<div class="flex items-center justify-between">
			<h3 class="text-sm font-black uppercase tracking-widest text-black">Targeting Rules</h3>
			...
			<div class="space-y-4">
				...
				>
					<div class="flex items-center gap-2 mb-3">
						...
						<span class="text-[10px] font-bold text-black/70 ml-1"
							>Pick a preset to get started instantly</span
						>
					</div>
