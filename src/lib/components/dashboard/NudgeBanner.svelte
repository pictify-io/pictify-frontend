...
<div class="bg-white rounded-2xl border-[3px] border-black shadow-[4px_4px_0_0_black] p-4 flex items-center gap-4 group hover:shadow-[2px_2px_0_0_black] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
	<!-- Lightbulb icon -->
	<div class="w-10 h-10 bg-[#ffc480]/20 rounded-xl border-[2px] border-[#ffc480] flex items-center justify-center flex-shrink-0">
	...
	<div class="flex-1 min-w-0">
		<p class="text-sm font-bold text-black leading-snug">{message}</p>
	</div>
	...
	<button
		...
		class="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-lg text-gray-400 hover:text-black hover:bg-gray-100 transition-colors"
		aria-label="Dismiss"
	>
