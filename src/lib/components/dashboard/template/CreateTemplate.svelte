    ...
    <div class="w-full flex justify-center">
        <div>
            <div class="flex items-center w-full">
                <div class="flex-grow">
                    <input type="text" placeholder="Template Name" class="w-full border-2 border-gray-300 p-2 rounded-md">
                </div>
                <div class="ml-5">
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 rounded ring-1 ring-black ring-opacity-5">
