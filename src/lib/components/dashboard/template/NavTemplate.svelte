...
<div class="py-2">
	<div class="flex items-center justify-between gap-4">
		...
		<button
			class="bg-brand-danger hover:bg-[#ff5252] text-white font-bold py-3 px-5 rounded-xl border-[3px] border-gray-900 shadow-[4px_4px_0_0_#1f293780] hover:shadow-[2px_2px_0_0_#1f293780] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 flex items-center gap-2"
