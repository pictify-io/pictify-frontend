      ...
      <div class="p-6">
        {#if generatedImageUrl}
          <div class="mb-4 border-[3px] border-black p-2 bg-gray-50">
            <img src={generatedImageUrl} alt="Your generated image" class="w-full h-auto max-h-32 object-contain" />
          </div>
        {/if}
        ...
        <ul class="space-y-2 mb-6">
          <li class="flex items-center gap-3 font-bold">
            <span class="w-6 h-6 bg-[#4ade80] border-[2px] border-black flex items-center justify-center text-white text-sm">
