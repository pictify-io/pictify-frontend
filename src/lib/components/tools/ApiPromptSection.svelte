<script>
	...
	export let description =
		'Trigger image generation straight from your product, workflow automations, or CI/CD with a single API call.';
		...
		<div class="grid gap-12 lg:grid-cols-[1.1fr,1fr] p-8 md:p-12 items-center">
			...
			<div class="flex flex-col justify-between gap-8">
				<div class="space-y-6">
					...
					<div class="space-y-4">
						<h2 class="text-3xl md:text-4xl font-black leading-tight text-gray-900 tracking-tight">
							{title}
						</h2>
			...
			<div class="relative">
				...
				>
					...
					>
						...
						<span class="text-xs font-mono font-bold text-gray-500 uppercase tracking-wider"
							>BASH</span
						>
					</div>
					...
					<div class="p-6 overflow-x-auto custom-scrollbar">
						<pre class="font-mono text-sm leading-relaxed text-gray-300 whitespace-pre-wrap"><code
