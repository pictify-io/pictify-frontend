	...
	<div class="max-w-7xl mx-auto px-6 relative z-10">
		...
		<div class="text-center mb-20">
			...
			<p class="text-xl text-gray-700 max-w-2xl mx-auto font-medium">
				Designers update visuals in the editor. Developers trigger them via API. Product, marketing,
				and ops teams ship changes without waiting on a deployment.
			</p>
		</div>
		...
		<div class="relative max-w-5xl mx-auto">
			<!-- Connecting Cable -->
			<div
				class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-24 z-0 hidden md:block"
			>
				<svg class="w-full h-full" viewBox="0 0 200 100" fill="none" stroke="currentColor">
					...
					{#if isSyncing}
						<circle r="6" fill="#4ade80" stroke="#1f2937" stroke-width="2">
							<animateMotion dur="1s" repeatCount="1" path="M0 50 H200" />
						</circle>
					{/if}
				</svg>
			</div>
					...
					>
						...
						<div class="flex justify-between items-center mb-4 border-b-2 border-gray-100 pb-2">
							<div class="flex gap-2">
								<div class="w-8 h-8 rounded bg-gray-100 border border-gray-300" />
								<div class="w-8 h-8 rounded bg-gray-100 border border-gray-300" />
							</div>
						...
						<div
							class="relative aspect-video bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center"
						>
							<!-- Editable Element -->
							<div
							...
							>
								...
								{#if activeStep === 0}
									<!-- Designer Cursor -->
									<div
										class="absolute -bottom-4 -right-4 pointer-events-none"
		...
		<div class="grid md:grid-cols-3 gap-6 mt-20">
			...
			>
				...
				<p class="text-sm text-gray-600">
					Template and copy updates shouldn't require a sprint. Ship changes instantly.
				</p>
			</div>
			<div
				class="bg-white p-6 rounded-xl border-[3px] border-gray-900 shadow-[4px_4px_0_0_#1f2937]"
			>
				...
				<p class="text-sm text-gray-600">
					Lock down brand guidelines while allowing for dynamic data injection.
				</p>
			</div>
			<div
				class="bg-white p-6 rounded-xl border-[3px] border-gray-900 shadow-[4px_4px_0_0_#1f2937]"
			>
				...
				<p class="text-sm text-gray-600">
					Designers own the 'look'. Developers own the 'logic'. Everyone wins.
				</p>
			</div>
		</div>
	</div>
