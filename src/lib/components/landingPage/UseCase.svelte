<div class="w-100 flex justify-center items-center mx-auto mt-10  md:mt-20 py-5 px-6 text-left md:text-center max-w-4xl space-y-8">
    <div>
 ...
 <div class="text-lg opacity-50 max-w-3xl text-left md:text-center mt-8 mb-20 md:ml-auto md:mr-auto">
   ...
   <div class="flex flex-col sm:flex-row text-center sm:mt-20">
    <div class="md:mr-4 mt-10 sm:mt-5">
        <div class="text-xl font-bold mb-5">
            Certificates
        </div>
        <div>
