	...
	<div class="max-w-6xl mx-auto px-6 relative z-10">
		<div class="text-center mb-20">
			...
			<h2 class="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 mb-6 leading-tight">
				Why not build it <br />
				<span
					class="relative inline-block text-gray-400 decoration-4 underline decoration-gray-300 underline-offset-8"
				>
					yourself?
				</span>
			</h2>
			<p class="text-xl text-gray-600 max-w-2xl mx-auto font-medium">
				Building an image renderer is easy. Maintaining it at scale costs 40+ engineering hours a
				month.
			</p>
		</div>
		...
		<div class="space-y-6">
			...
			{#each comparisonPoints as point}
				<div class="group relative">
					...
					<div class="hidden md:block absolute top-1/2 left-0 w-full h-[2px] bg-gray-100 -z-10" />

					<div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
						<!-- Headless Side (Pain) -->
						<div class="md:col-span-5 relative">
							<div
								class="h-full bg-white p-6 rounded-xl border-[2px] border-dashed border-gray-300 group-hover:border-gray-400 transition-colors flex items-center gap-4 opacity-70 group-hover:opacity-100 grayscale group-hover:grayscale-0 transition-all duration-300"
							>
								<div
						...
						<div class="md:col-span-2 flex items-center justify-center py-2 md:py-0">
							<div
								class="bg-gray-900 text-white text-xs font-bold px-4 py-1.5 rounded-full border-[2px] border-white shadow-lg z-10 whitespace-nowrap"
							>
								{point.title}
							</div>
						</div>
						...
						<div class="md:col-span-5 relative">
							...
							>
								<!-- Glow Effect -->
								<div
									class="absolute inset-0 {point.pictify
										.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-300"
								/>

								<div
									class="w-12 h-12 {point.pictify.bg} rounded-lg border-2 {point.pictify
										.border} flex items-center justify-center flex-shrink-0 relative z-10"
								>
									<svg
										class="w-6 h-6 {point.pictify.color}"
										fill="none"
										stroke="currentColor"
										viewBox="0 0 24 24"
										><path
											...
											stroke-linejoin="round"
											stroke-width="2"
											d={point.pictify.icon}
										/></svg
									>
								</div>
								<div class="relative z-10">
									<div class="text-xs font-bold {point.pictify.color} uppercase mb-1 md:hidden">
										The Pictify Way
									</div>
		...
		<div class="mt-16 text-center">
			<div
				class="inline-flex items-center gap-2 text-gray-500 font-medium bg-white px-6 py-3 rounded-full border border-gray-200 shadow-sm"
			>
