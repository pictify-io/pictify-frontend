		...
		},
		{
			...
			template: (data, animate) => `
				<div class="h-full bg-gray-900 border-l-8 border-[#ffc480] p-6 flex flex-col justify-between relative overflow-hidden">
					...
					${
						animate
							? `<div class="absolute bottom-4 right-4 w-12 h-12 bg-white p-1"><div class="w-full h-full bg-black"></div></div>`
							: ''
					}
				</div>
			`
	...
	<div class="max-w-7xl mx-auto px-6 relative z-10">
		...
		<div class="text-center mb-16 md:mb-20">
			...
			<p class="text-xl text-gray-700 max-w-2xl mx-auto font-medium">
				Connect your templates to any API endpoint. Pictify binds live data and regenerates
				automatically. One URL, always fresh output.
			</p>
		</div>
		...
		<div class="relative max-w-5xl mx-auto">
			...
			<div
				class="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-24 h-12"
			>
				<div class="relative w-full h-full flex items-center justify-center">
					...
					<!-- Arrow Head -->
					<div
						class="absolute right-0 w-0 h-0 border-t-[10px] border-t-transparent border-l-[16px] border-l-gray-900 border-b-[10px] border-b-transparent translate-x-1"
					/>
					<!-- Badge -->
					<div
			...
			<div class="grid md:grid-cols-2 gap-8 md:gap-20 items-stretch">
				...
				<div class="relative group">
					<!-- Window Chrome -->
					<div class="absolute -top-3 -left-3 w-full h-full bg-gray-900 rounded-2xl" />
					<div
						class="relative bg-[#1e1e1e] rounded-2xl border-[3px] border-gray-900 overflow-hidden h-full min-h-[320px] flex flex-col shadow-[8px_8px_0_0_#4ade80] transition-transform hover:-translate-y-1"
					>
						<!-- Header -->
						<div
				...
				<div class="relative group mt-8 md:mt-0">
					<!-- Window Chrome -->
					<div class="absolute -top-3 -right-3 w-full h-full bg-gray-900 rounded-2xl" />
					<div
						class="relative bg-white rounded-2xl border-[3px] border-gray-900 overflow-hidden h-full min-h-[320px] flex flex-col shadow-[8px_8px_0_0_#ffc480] transition-transform hover:-translate-y-1"
					>
						<!-- Browser Bar -->
						<div
							class="bg-gray-100 px-4 py-3 flex items-center gap-3 border-b-[3px] border-gray-900"
						>
							<div
								class="flex-1 bg-white border-[2px] border-gray-300 rounded-md px-3 py-1 flex items-center gap-2 overflow-hidden"
							>
								<svg
						...
						<!-- Canvas -->
						<div
							class="flex-1 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] p-8 flex items-center justify-center overflow-hidden"
						>
							{#key VariationIndex}
								<div
