	...
	<div class="max-w-7xl mx-auto px-6">
		<div class="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
			...
			<div class="relative z-10 w-full lg:max-w-xl">
				<div
					class="inline-flex items-center gap-2 px-5 py-2 bg-brand-danger border-[3px] border-gray-900 shadow-brutal-sm rounded-full transform -rotate-2 mb-6"
				>
				...
				<div class="space-y-6 mb-12">
					<div class="flex items-start gap-5 group">
						<div
							class="w-14 h-14 bg-brand-accent rounded-xl border-[3px] border-gray-900 flex items-center justify-center flex-shrink-0 shadow-brutal-lg group-hover:translate-x-1 group-hover:translate-y-1 group-hover:shadow-brutal-sm transition-all"
						>
							<svg class="w-7 h-7 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
						</div>
						<div class="pt-1">
							<h3 class="text-xl font-black text-gray-900 mb-1">Predictable & Fast</h3>
					...
					<div class="flex items-start gap-5 group">
						<div
							class="w-14 h-14 bg-data-green rounded-xl border-[3px] border-gray-900 flex items-center justify-center flex-shrink-0 shadow-brutal-lg group-hover:translate-x-1 group-hover:translate-y-1 group-hover:shadow-brutal-sm transition-all"
						>
							<svg class="w-7 h-7 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
						</div>
						<div class="pt-1">
							<h3 class="text-xl font-black text-gray-900 mb-1">Async Webhooks</h3>
							<p class="text-gray-900/70 font-medium text-lg leading-relaxed">
					...
					<div class="flex items-start gap-5 group">
						<div
							class="w-14 h-14 bg-brand-danger rounded-xl border-[3px] border-gray-900 flex items-center justify-center flex-shrink-0 shadow-brutal-lg group-hover:translate-x-1 group-hover:translate-y-1 group-hover:shadow-brutal-sm transition-all"
						>
				...
				<a
					...
					target="_blank"
					class="inline-flex items-center gap-3 px-8 py-5 bg-gray-900 text-white text-lg font-black uppercase tracking-wider rounded-2xl border-[3px] border-gray-900 shadow-[6px_6px_0_0_#ffc480] hover:shadow-brutal-accent-sm hover:translate-x-1 hover:translate-y-1 transition-all"
				>
			...
			<div class="relative w-full z-10 mx-auto group">
				...
				<div class="absolute inset-0 bg-brand-accent rounded-2xl border-[3px] border-gray-900 transform translate-x-3 translate-y-3 z-0 pointer-events-none"></div>

				<div class="relative bg-[#1e1e1e] rounded-2xl border-[3px] border-gray-900 shadow-brutal-2xl flex flex-col overflow-hidden z-10 transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 duration-300 min-h-[400px] md:min-h-[500px]">
					...
					<div class="bg-[#2d2d2d] px-4 py-3 border-b-[3px] border-black flex items-center justify-between">
						...
						<div class="flex items-center gap-2 bg-gray-900/40 px-3 py-1 rounded-md border border-white/10">
