		...
		<div class="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
			...
			<div class="md:col-span-4 flex flex-col gap-6">
				<a href="/" class="inline-block group">
					<div class="flex items-center gap-3">
						<!-- Logo Icon -->
						<div
							class="w-10 h-10 bg-gray-900 rounded-md flex items-center justify-center shadow-[3px_3px_0_0_#ffc480] group-hover:shadow-none group-hover:translate-x-0.5 group-hover:translate-y-0.5 transition-all"
						>
						...
						<!-- Text -->
						<span
							class="text-3xl font-black text-gray-900 tracking-tight group-hover:translate-x-1 transition-transform"
							>PICTIFY</span
						>
					</div>
				</a>
				...
				>
					...
					<span class="text-sm font-bold text-gray-900 group-hover:text-gray-700"
			...
			<div class="md:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
				...
				<div class="flex flex-col gap-4">
					<div
						class="text-sm font-black text-gray-900 uppercase tracking-wider border-b-[3px] border-gray-900 pb-2 w-fit"
					>
						Product
					</div>
				...
				<div class="flex flex-col gap-4">
					...
					<div class="flex flex-col gap-3">
						<a
							href="https://twitter.com/pictify_io"
							target="_blank"
						...
						<a
							href="https://github.com/AirTribe"
							target="_blank"
							class="flex items-center gap-2 group"
						>
							<div
