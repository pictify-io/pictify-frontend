...
<div class="h-full flex flex-col bg-[#FFFDF8]">
	...
	<!-- Content Area -->
	<div
		class="flex-1 overflow-y-auto p-4 bg-[#FFFDF8] relative scrollbar-thin scrollbar-thumb-gray-900 scrollbar-track-transparent"
	>
		<!-- Background Grid -->
		<div
							...
							<div class="space-y-2">
								{#each groupedAssets.font as asset}
									...
									>
										...
										<span
											class="text-[9px] font-mono font-bold text-gray-400 uppercase group-hover:text-[#ff6b6b] transition-colors relative z-10"
										>
						...
						{#each filteredAssets as asset}
							{#if selectedType === 'font'}
								...
								>
									...
									<span
										class="text-[9px] font-mono text-gray-400 mt-1 block uppercase group-hover:text-[#ff6b6b]"
