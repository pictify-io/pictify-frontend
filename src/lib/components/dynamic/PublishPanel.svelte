		...
		<div class="space-y-6">
			...
			<div class="p-6 bg-gradient-to-br from-gray-50 to-white border-[3px] border-gray-900 rounded-xl shadow-[4px_4px_0_0_#1f2937]">
				...
				<div class="flex items-stretch gap-3">
					<code class="flex-1 px-4 py-3 bg-white border-[3px] border-gray-200 rounded-lg text-sm font-black font-mono text-gray-700 truncate">
						{dynamicUrl}
					</code>
					<button
			...
			<div class="p-6 bg-white border-[3px] border-gray-900 rounded-xl shadow-[4px_4px_0_0_#1f2937]">
				<h3 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-4">Embed Code (HTML)</h3>
				<div class="flex items-stretch gap-3">
					<code class="flex-1 px-4 py-3 bg-[#1a1a1a] border-[3px] border-gray-900 rounded-lg text-xs font-mono text-green-400 truncate">
						{generateEmbedCode()}
					</code>
					<button
						class="px-6 py-2 bg-gray-900 hover:bg-black text-white text-xs font-black uppercase tracking-wide rounded-lg border-[3px] border-gray-900 shadow-[3px_3px_0_0_#9ca3af] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0_0_#9ca3af] active:shadow-none active:translate-x-[3px] active:translate-y-[3px] transition-all"
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
				<div class="p-4 bg-white border-[3px] border-gray-900 rounded-xl shadow-[4px_4px_0_0_#9ca3af]">
					<h4 class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Last Rendered</h4>
					<p class="text-sm font-black text-gray-900">{formatDate(lastRenderAt)}</p>
				</div>
				<div class="p-4 bg-white border-[3px] border-gray-900 rounded-xl shadow-[4px_4px_0_0_#9ca3af]">
					<h4 class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Next Refresh</h4>
					<p class="text-sm font-black text-gray-900">~ {formatTtl(refreshPolicy.ttlSeconds)}</p>
				</div>
				<div class="p-4 bg-white border-[3px] border-gray-900 rounded-xl shadow-[4px_4px_0_0_#9ca3af]">
					<h4 class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Health Status</h4>
					{#if lastError}
						<div class="flex items-center gap-2">
			...
			{#if lastError}
				<div class="p-4 bg-red-50 border-[3px] border-red-200 rounded-xl flex items-start gap-4">
					...
					<div>
						<h4 class="text-sm font-black text-red-900 uppercase tracking-wide mb-1">Error Details</h4>
