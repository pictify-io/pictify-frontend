<script>
	...
	$: remainingBudgetFormatted =
		remainingBudget !== null ? `$${(remainingBudget / 100).toFixed(2)}` : null;
		...
		>
			...
			<div class="p-6 border-b-3 border-gray-900 bg-[#ff6b6b]/10">
				<div class="flex items-start gap-4">
					...
					<div>
						...
						<p class="text-sm font-medium text-gray-600 mt-1">You've reached your monthly limit</p>
					</div>
				</div>
			</div>
			...
			<div class="p-6 space-y-4">
				<p class="text-gray-700 font-medium">
					This render will be billed as an overage at <span class="font-black text-gray-900"
						>{rateFormatted || overageCostFormatted}</span
					> per render.
				</p>
