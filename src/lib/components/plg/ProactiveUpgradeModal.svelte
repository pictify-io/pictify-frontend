<script>
  ...
  $: discountInfo = getDiscountForUsage($usageWidget.percentage) || { discountPercent: 5, discountCode: 'EARLY5', urgency: 'warning' };
    ...
    >
      ...
      <div class="bg-[#ffc480] p-6 relative border-b-[3px] border-gray-900">
        ...
        <div class="relative z-10 pr-16">
          <div class="mb-3 transform -rotate-6 w-fit bg-white p-2 rounded-lg border-2 border-gray-900 shadow-[2px_2px_0_0_#1f2937]">
