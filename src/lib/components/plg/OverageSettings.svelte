<script>
  ...
  import { OVERAGE_PRICING, isOverageEligible, formatOverageRate } from '../../../config/plan-features.js';
  ...
  $: remainingBudgetCents = spendingCapCents ? Math.max(0, spendingCapCents - currentCycleOverageCostCents) : null;
  $: remainingBudgetDollars = remainingBudgetCents !== null ? (remainingBudgetCents / 100).toFixed(2) : null;
  ...
  <div class="bg-gray-100 border-b-[3px] border-gray-900 p-4">
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Manage overages & caps</p>
      </div>
    </div>
  </div>
