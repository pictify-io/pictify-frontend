...
export const linkedinBannerCategories = [
	{
		...
		label: 'Developer',
		icon: 'code',
		description: 'Perfect for software engineers, full-stack developers, and tech professionals'
	},
	{
		id: 'designer',
		label: 'Designer',
		icon: 'palette',
		description: 'Creative banners for UI/UX designers, graphic designers, and artists'
	},
	{
		id: 'marketer',
		label: 'Marketer',
		icon: 'megaphone',
		description: 'Eye-catching banners for marketing professionals and growth hackers'
	},
	{
		id: 'recruiter',
		label: 'Recruiter',
		icon: 'users',
		description: 'Professional banners for HR and talent acquisition specialists'
	},
	{
		id: 'freelancer',
		label: 'Freelancer',
		icon: 'briefcase',
		description: 'Stand out as an independent professional or consultant'
	},
	{
		id: 'corporate',
		label: 'Corporate',
		icon: 'building',
		description: 'Clean, professional banners for executives and business leaders'
	},
	{
		id: 'neo-brutalist',
		label: 'Neo-Brutalist',
		icon: 'star',
		description: 'Bold, high-contrast designs that make a statement'
	},
	{
		id: 'personal-brand',
		label: 'Personal Brand',
		icon: 'star',
		description: 'Build your personal brand with impactful banners'
	}
];
...
export const linkedinPersonas = [
	{
		...
		description:
			'Create professional LinkedIn banners designed for software developers. Dark themes, code aesthetics, and tech-focused designs that showcase your programming expertise.',
		tips: [
			'Highlight your tech stack',
			'Use dark or terminal-style themes',
			'Include GitHub stats or contributions'
		],
	...
	},
	{
		...
		description:
			'Beautiful LinkedIn banners for creative professionals. Showcase your design aesthetic with elegant typography and striking visuals.',
	...
	},
	{
		...
		description:
			'High-converting LinkedIn banners for marketing professionals. Include CTAs, social proof, and brand-building elements.',
	...
	},
	{
		...
		description:
			'Professional LinkedIn banners that attract top talent. Show your company culture and open positions.',
	...
	},
	{
		...
		description:
			'Stand out as an independent professional with banners that showcase your expertise and services.',
		tips: [
			'Highlight your specialty',
			'Add contact info or website',
			'Show client logos if permitted'
		],
	...
	},
	{
		...
		description:
			'Clean, authoritative LinkedIn banners for C-suite executives and business leaders.',
		tips: [
			'Keep it professional and clean',
			'Add company branding subtly',
...
export const linkedinBannerUseCases = [
	{
		...
		description:
			'Create a LinkedIn banner that helps you stand out to recruiters and hiring managers.',
		tips: [
			'Highlight your key skills',
			'Add "Open to Work" messaging',
			'Keep it professional yet memorable'
		]
	},
	{
		...
		description:
			'Establish your authority with a banner that showcases your expertise and personal brand.',
		tips: [
			'Include your signature topic',
			'Add speaking credentials',
	...
	},
	{
		...
		description:
			'Build credibility and attract investors, partners, and customers with a founder-focused banner.',
		tips: [
			'Feature your startup branding',
