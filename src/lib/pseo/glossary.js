...
export const glossary = [
	...
	},
	{
		...
		longDefinition: 'HTML to Image conversion is the process of rendering HTML and CSS markup as a static image file (PNG, JPG, WebP, etc.). This is typically done using headless browsers like Chromium that can render web pages and capture screenshots. The technique is essential for generating dynamic images like social cards, certificates, receipts, and other visual content from templates.',
	...
	},
	{
		...
		longDefinition: 'A social preview is the visual representation of a link when shared on social media platforms or messaging apps. It typically includes an image, title, and description. The preview is generated from Open Graph and Twitter Card meta tags in your HTML. A well-designed social preview can dramatically increase engagement and click-through rates.',
	...
	},
	{
		...
		shortDefinition: 'A distributed network of servers that delivers content with high availability and performance.',
		longDefinition: 'A Content Delivery Network (CDN) is a geographically distributed network of servers that work together to deliver content quickly to users based on their location. For image generation services, CDN hosting means your generated images are cached and served from edge servers worldwide, resulting in faster load times and better reliability.',
	...
	},
	{
		...
		longDefinition: "Dynamic images are images generated on-the-fly based on parameters passed at request time. Unlike static images stored on a server, dynamic images are created in real-time with personalized content—a user's name, current data, or contextual information. This enables personalization at scale without pre-generating every possible variation.",
	...
	},
	{
		...
		longDefinition: 'GIF generation is the process of creating animated GIF images. This can involve rendering multiple HTML frames as images and combining them into an animation, converting video clips, or creating frame-by-frame animations programmatically. Animated GIFs are useful for product demos, tutorials, and eye-catching social media content.',
	...
	},
	{
		...
		longDefinition: "Aspect ratio is the proportional relationship between an image's width and height, expressed as two numbers separated by a colon (like 16:9 or 1:1). Different platforms prefer different aspect ratios—Instagram feed posts work best at 1:1 (square), Stories at 9:16 (vertical), and OG images at 1.91:1 (landscape). Understanding aspect ratios ensures your images display correctly across platforms.",
