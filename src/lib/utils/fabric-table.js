...
export function createStatsTable(config = {}) {
  ...
  const valueColor = tableStyle.headerBg === 'transparent' ? tableStyle.textColor : tableStyle.headerBg;
...
export function createComparisonTable(config = {}) {
  const {
    ...
    plans = [
      ...
      { name: 'Enterprise', values: ['Unlimited', '∞', 'Dedicated', '✓', '✓'], price: '$99/mo', highlighted: false }
    ],
    cellWidth = 120,
    cellHeight = 40,
    headerHeight = 60,
